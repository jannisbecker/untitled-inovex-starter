...
interface CalendarProps {
    ...
    view?: "month" | "week" | "day";
    /** Override the default start date shown in the calendar (defaults to today). */
    initialDate?: CalendarDate;
    className?: string;
}

export const Calendar = ({ events, view: defaultView = "month", initialDate, className }: CalendarProps) => {
    ...
    const [currentMonthDate, setCurrentMonthDate] = useState(() => initialDate ?? today(timeZone));
    const [selectedDate, setSelectedDate] = useState<CalendarDate | null>(initialDate ?? today(timeZone));
